...
const SKILLS: Skill[] = [
  ...
  // SenseNova Skills
  { id: 'sn-deep-research', name: 'SenseNova Deep Research', description: 'Full-pipeline deep research — planning, multi-source evidence, synthesis, and report generation', category: 'ai-ml', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['research', 'report', 'evidence'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-deep-research', author: 'SenseNova', featured: true },
  { id: 'sn-infographic', name: 'SenseNova Infographic', description: 'Generate professional infographics with various layouts and visual styles', category: 'documents', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['infographic', 'visual', 'design'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-infographic', author: 'SenseNova' },
  { id: 'sn-ppt-entry', name: 'SenseNova PPT', description: 'AI-powered presentation creation — standard and creative modes with full-page visuals', category: 'documents', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['ppt', 'slides', 'creative'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-ppt-entry', author: 'SenseNova' },
  { id: 'sn-da-excel-workflow', name: 'SenseNova Excel Analysis', description: 'End-to-end Excel data analysis — cleaning, filtering, aggregation, charts, and export', category: 'documents', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['excel', 'data-analysis', 'pivot'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-da-excel-workflow', author: 'SenseNova' },
  { id: 'sn-image-base', name: 'SenseNova Image Gen', description: 'Image generation, recognition (VLM), and text optimization APIs', category: 'ai-ml', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['image-gen', 'vlm', 'vision'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-image-base', author: 'SenseNova' },
  { id: 'sn-md-to-html-report', name: 'SenseNova HTML Report', description: 'Convert Markdown research reports to polished HTML with charts and styling', category: 'documents', logo: 'https://avatars.githubusercontent.com/u/215225587', tags: ['markdown', 'html', 'report'], sourceRepo: 'OpenSenseNova/SenseNova-Skills', sourcePath: 'skills/sn-md-to-html-report', author: 'SenseNova' },
];
