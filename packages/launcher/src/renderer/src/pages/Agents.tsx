...
import StatusDot, { displayState } from "../components/StatusDot"
        ...
        <DialogContent>
          <div className="flex flex-col items-center" style={{ padding: "8px 0" }}>
            ...
            <DialogHeader className="items-center">
              <DialogTitle style={{ marginTop: 12 }}>
                Remove {removeTarget}?
              </DialogTitle>
            </DialogHeader>
            <p
              className="hint"
              style={{ margin: "12px 0 20px", textAlign: "center" }}
            >
...
function ConfigureDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>Configure {agentName || agentType}</DialogTitle>
        </DialogHeader>
        {loading ? (
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent>
        <DialogHeader>
          <DialogTitle>
            Connect &apos;{agentName}&apos; to Workspace
          </DialogTitle>
        </DialogHeader>
        {view === "list" && (
          <>
